...
const foreignLanguageLoader = (arg) =>{
    return arg;
}
...
function LoadForeignLanguagePreference()
{
    const localStorageItem = localStorage.getItem('foreignLanguageSelection');
    const foreignLanguage = localStorageItem?.foreignLanguageSelection || "englishToHebrewDict"
    return foreignLanguageLoader(foreignLanguage);
}